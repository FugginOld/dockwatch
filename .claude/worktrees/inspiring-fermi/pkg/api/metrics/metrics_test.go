...
import (
	...
	metricsAPI "github.com/fugginold/dockwatch/pkg/api/metrics"
...
var _ = Describe("the metrics API", func() {
	...
	It("should serve metrics", func() {
		...
		Expect(tryGetMetrics()).To(HaveKeyWithValue("dockwatch_containers_updated", "0"))
		...
		Eventually(tryGetMetrics).Should(SatisfyAll(
			HaveKeyWithValue("dockwatch_containers_updated", "3"),
			HaveKeyWithValue("dockwatch_containers_failed", "1"),
			HaveKeyWithValue("dockwatch_containers_scanned", "4"),
			HaveKeyWithValue("dockwatch_scans_total", "1"),
			HaveKeyWithValue("dockwatch_scans_skipped", "0"),
		))
		...
		Eventually(tryGetMetrics).Should(SatisfyAll(
			HaveKeyWithValue("dockwatch_scans_total", "4"),
			HaveKeyWithValue("dockwatch_scans_skipped", "3"),
		))
	})
})
