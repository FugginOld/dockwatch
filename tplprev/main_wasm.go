...
import (
	...
	"github.com/fugginold/dockwatch/pkg/notifications/preview"
	"github.com/fugginold/dockwatch/pkg/notifications/preview/data"

	"syscall/js"
)

func main() {
	fmt.Println("dockwatch/tplprev v" + meta.Version)

	js.Global().Set("DOCKWATCH", js.ValueOf(map[string]any{
