...
var _ = Describe("the manifest module", func() {
	Describe("BuildManifestURL", func() {
		It("should return a valid url given a fully qualified image", func() {
			imageRef := "ghcr.io/fugginold/dockwatch:mytag"
			expected := "https://ghcr.io/v2/fugginold/dockwatch/manifests/mytag"
		...
		It("should assume Docker Hub for image refs with no explicit registry", func() {
			imageRef := "fugginold/dockwatch:latest"
			expected := "https://index.docker.io/v2/fugginold/dockwatch/manifests/latest"
