...
// SetStale sets the stale field for the container
...
// container. Returns an empty ID if image info is not set.
func (c Container) ImageID() wt.ImageID {
	return c.SafeImageID()
}
...
// could result in dockwatch waiting forever.
